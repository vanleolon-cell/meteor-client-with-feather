...
public abstract class ChatHudMixin implements IChatHud {
    ...
    private void onRender_afterDrawTextWithShadow(DrawContext context, net.minecraft.client.font.TextRenderer textRenderer, int mouseX, int mouseY, int tickDelta, boolean focused, boolean focused2, CallbackInfo info) {
        getBetterChat().afterDrawMessage();
    }

    // No Message Signature Indicator
    // FIXED: Removed injection that targets a method that doesn't exist in 1.21.8
